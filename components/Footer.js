...
const Footer = () => {
  return (
    <div>
      <footer style={{backgroundColor: '#f5f5f0'}} className="text-gray-600 body-font">
  <div className="container  px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      <Link href={"/"}>
      <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        <Image src="/nirucart.jpg" alt="" width="300" height="250" />
      </a> 
      </Link>
      <p className="mt-0 mx-2 font-medium text-xl text-gray-600 px-4">Wear the &lt;/code&gt;</p>
    </div>
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2022 nirucart.com — All Rights Reserved
        <a href="https://twitter.com/nirupam" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@nirupam</a>
      </p>
