        ...
        <section className="text-gray-600 body-font">
          <div className="text-black-600 mx-2 md:mx-10 my-2 py-24">
            ...
            <p className="px-10 py-2">
              ...
              the use of nirucart's Website, located at www.nirucart.com. By
              accessing this website we assume you accept these terms and
              conditions. Do not continue to use nirucart.com if you do not
            ...
            <p className="px-10 py-2">
              Unless otherwise stated, nirucart and/or its licensors own the
              intellectual property rights for all material on nirucart.com.
              All intellectual property rights are reserved. You may access this
              from nirucart.com for your own personal use subjected to
              restrictions set in these terms and conditions.
            </p>
            <div>
              <p className="mb-4 mx-10 font-semibold">You must not:</p>
              <li className="ml-10">Republish material from nirucart.com</li>
              <li className="ml-10">
                Sell, rent or sub-license material from nirucart.com
              </li>
              <li className="ml-10">
                Reproduce, duplicate or copy material from nirucart.com
              </li>
              <li className="ml-10">Redistribute content from nirucart.com</li>
            </div>
            ...
            <p className="mx-10 my-2 ">
              ...
              nirucart does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of nirucart, its agents and/or affiliates.
              ...
              laws, nirucart shall not be liable for the Comments or for any
              ...
              on this website. nirucart reserves the right to monitor all
            ...
            <div>
              ...
              <p className="mx-10 my-2">
                You hereby grant nirucart a non-exclusive license to use,
            ...
            <p className="px-10 py-2">
              ...
              nirucart; and (d) the link is in the context of general resource
              ...
              website, you must inform us by sending an e-mail to nirucart.
            ...
            <div>
              ...
              <p className="ml-10 mt-4">
                No use of nirucart's logo or other artwork will be allowed for
            ...
            <p className="px-10 py-2">
              ...
              uncertain event if we are being not able to fulfil the order, we
              ...
              event actually ends, whether or not this is the same as the
              tentative date.
            </p>
